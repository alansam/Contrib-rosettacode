/* Generated from 'RCNthRoot.nrx' 28 May 2026 21:51:58 [v5.10] */
...
public class RCNthRoot{
 ...
 public static netrexx.lang.Rexx root(netrexx.lang.Rexx x,netrexx.lang.Rexx r,netrexx.lang.Rexx digs){
  ...
  netrexx.lang.Rexx underscore=null;
  ...
  {$4:for(;;){
   ...
   {$3:for(;;){
    underscore=((Rm1.OpMult($2,g.OpPow($2,r)).OpAdd($2,ax))).OpDiv($2,r).OpDiv($2,g.OpPow($2,Rm1));/*this is the nitty-gritty stuff.*/
    if (underscore.OpEq($2,g)|underscore.OpEq($2,old)) 
  ...
  underscore=g.OpMult($2,x.sign());/*correct the sign (maybe).      */
  if (oldR.OpLt($2,$07)) 
   return new netrexx.lang.Rexx(underscore.OpEq($2,$08.OpDiv($2,underscore)));/*root < 0 ?    Reciprocal it is.*/
  $2.setDigits(oldDigs);/*re-instate the original digits.*/
  return underscore.OpDiv($2,$08);/*normalize the number to digs.  */
  }
