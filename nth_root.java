/* Generated from 'nth_root.nrx' 28 May 2026 22:43:18 [v5.10] */
...
public class nth_root{
 ...
 public static netrexx.lang.Rexx root(netrexx.lang.Rexx x,netrexx.lang.Rexx r,netrexx.lang.Rexx digs){
  ...
  {$4:for(;;){
   ...
   {$3:for(;;){
    underscore=((Rm1.OpMult($2,g.OpPow($2,r)).OpAdd($2,ax))).OpDiv($2,r).OpDiv($2,g.OpPow($2,Rm1));
  ...
  underscore=g.OpMult($2,x.sign());
  if (oldR.OpLt($2,$07)) 
   return new netrexx.lang.Rexx(underscore.OpEq($2,$08.OpDiv($2,underscore)));
  $2.setDigits(oldDigs);
  return underscore.OpDiv($2,$08);
  }
